                    ...
                    <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="lg:col-span-7 flex flex-col justify-center lg:pr-12">
                            ...
                            <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-[1.1] tracking-tight">
                                Building the <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-orange-400 to-yellow-400">Sanctuary</span> for <br />
                                Thought.
                            </h1>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={idx} className="p-8 rounded-2xl bg-background-dark border border-border-dark hover:border-primary/50 transition-colors group" style={{ animationDelay: `${300 + (idx * 100)}ms` }}>
                ...
                <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                    ...
                    <div className="relative border-l border-border-dark ml-4 md:ml-0 space-y-12 pl-8 md:pl-0">
                        {[
                            ...
                            <div key={idx} className="relative md:grid md:grid-cols-5 md:gap-8 items-start" style={{ animationDelay: `${500 + (idx * 100)}ms` }}>
