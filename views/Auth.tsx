...
const Auth: React.FC<AuthProps> = ({ view }) => {
    ...
    const { user, signIn, signUp, verifyOtp, resendOtp, resetPassword, signInWithOAuth } = useAuth();
            ...
            <div className="w-full max-w-md animate-in fade-in zoom-in duration-300 bg-sidebar-dark border border-border-dark rounded-xl shadow-2xl overflow-hidden">
                ...
                <div className="px-4 pb-8 sm:px-8 sm:pb-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <button type="button" onClick={() => handleOAuthLogin('google')} disabled={!!oauthLoading} className="flex items-center justify-center gap-2 px-4 py-2.5 border border-border-dark rounded-lg bg-[#141619] hover:bg-[#1E2126] transition-colors group disabled:opacity-50 disabled:cursor-not-allowed">
                            {oauthLoading === 'google' ? (
                                <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>
                            ) : (
                        ...
                        <button type="button" onClick={() => handleOAuthLogin('github')} disabled={!!oauthLoading} className="flex items-center justify-center gap-2 px-4 py-2.5 border border-border-dark rounded-lg bg-[#141619] hover:bg-[#1E2126] transition-colors group disabled:opacity-50 disabled:cursor-not-allowed">
                            {oauthLoading === 'github' ? (
                                <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>
                            ) : (
